                        ...
                        <div class="container">
                          <form  action="addexec.php" method="post" enctype="multipart/form-data" name="addroom" onsubmit="return validateForm()">
                            <div class="form-group row">
                              <div class="col-sm-10">
                                <input name="type" type="text" class="form-control" id="inputEmail3" placeholder="Product Name" required="">
                              </div>
                            </div>
                            <div class="form-group row">
                              <div class="col-sm-10">
                                <input name="rate" type="text" class="form-control" id="inputPassword3" placeholder="Product Price" required="">
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-10">
                                ...
                                <textarea name="desc" placeholder="Product Description..." class="form-control" cols="15" required=""></textarea>
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <div class="col-sm-10">
                                ...
                                <input type="file" class="form-control" name="image" style="margin-bottom:2%;">
                              </div>
                            </div>
