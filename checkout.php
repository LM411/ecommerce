...
<html lang="en">
  <head>
    ...
    <title>Custom It |Checkout</title>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="index.php">Custom IT-<span>EStore</span></a></h1>
                    </div>
                </div>
                
                <div class="col-sm-6">
                    <div class="shopping-item">
                        <a href="cart.html">Cart - <span class="cart-amunt">M800</span> <i class="fa fa-shopping-cart"></i> <span class="product-count">5</span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="shop.php">Start Shopping</a></li>
                                        ...
                                        <tbody>
                                            <tr class="cart_item">
                                                ...
                                                <td class="product-total">
                                                    <span class="amount">R15.00</span> </td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            ...
                                            <tr class="cart-subtotal">
                                                <th>Cart Subtotal</th>
                                                <td><span class="amount">R15.00</span>
                                                </td>
                                            </tr>
                                            ...
                                            <tr class="order-total">
                                                <th>Order Total</th>
                                                <td><strong><span class="amount">R15.00</span></strong> </td>
                                            </tr>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>Custom IT-<span>Estore</span></h2>
                        <p>Lesotho's Best Electronic Online store. Our prices are affordable, our means of paymemt convinient, our team is here to support you 24/7. We are the best yet</p>
